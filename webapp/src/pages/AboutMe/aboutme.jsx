      ...
      <div className="px-48 relative items-center justify-center bg-white">
        ...
        <div className="space-y-8">
          ...
          <div className=" items-center justify-between">
            <div className="border-4 border-gray-600 ml-4 bg-gray-200 object-none w-36 h-36 rounded-full custom-position">
              <img
                src={profileImage}
                className="object-fill w-34 h-34 rounded-full"
              ></img>
            </div>
            <div>
